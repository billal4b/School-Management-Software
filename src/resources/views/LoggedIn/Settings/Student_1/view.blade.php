...
<table class="table table-striped table-bordered table-condensed table-hover" id="myTable">
    ...
    <tbody>  
        ...
        <tr>		
            ...
            <td>
                <a class="btn btn-sm btn-primary" href="{{ url(route('LoggedIn.Settings.studentsView.edit', array('id' => $irt->student_id)))  }}" target="_blank"><i class="fa fa-pencil"></i> Update</a>
            </td>
        </tr>	       	
        @endforeach
        @endif 
