            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" id='students_view_form' onsubmit="return false;" >
                    ...
                    <div class="form-group form-group-sm">				
                        <label for="branch_and_version" class="col-sm-1 control-label">Branch </label>
                        <div class="col-sm-2">
                        ...
                        <label for="class_name" class="col-sm-1 control-label">Class </label>
                        <div class="col-sm-2">
                        ...
                        <label for="group_name" class="col-sm-1 control-label">Group </label>
                        <div class="col-sm-2">
                        ...
                        <label for="section_name" class="col-sm-1 control-label">Section </label>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group form-group-sm">								
                        <label for="system_generated_student_id" class="col-sm-1 control-label">Student ID </label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="system_generated_student_id" id="system_generated_student_id">
                        </div>
