...
//            return;
        ...
        $(document).on('click', '#SelectUnselectAllCheckbox', function () {
            ...
            $('#Table_GetStudentsForAttendance tbody tr').find('td:nth-child(2) :checkbox').each(function () {
                ...
                $(this).next().append(checkedStatus == true ? '<span class="label label-success">Present</span>' : '<span class="label label-danger">Absent</span>');
//                if(checkedStatus == false){
//                    $(this).find('td:nth-child(3)').html('<span class="label label-danger">Absent</span>');
//                }else{
//                    $(this).find('td:nth-child(3)').html('<span class="label label-success">Present</span>');
//                }
            });
        });
    ...
    $(document).on('click', 'input[name="AttendedStudentID[]"]', function(){
        if($(this).prop('checked') == true){
            $(this).next().find('span').remove();
                $(this).next().append('<span class="label label-success">Present</span>');
        }else{
            $(this).next().find('span').remove();
            $(this).next().append('<span class="label label-danger">Absent</span>');
        }
    });
    });
</script>
