...
class GeneralTeacherController extends Controller {
    ...
    private $ViewPagePath = 'LoggedIn.SMS.GeneralTeacher.';
...
//            $str = 'Username=mpsc&Password=Mpsc@123&From=8801847169935&To=' . $ContactNo[$i]->phone_no . '&Message=' . $SMSBody;
//            echo $str . '<br>';
            $ch = curl_init();
